  ...
  return (
    <Container className="max-w-3xl sm:px-6 lg:px-8 py-12 text-golddark">
      ...
      <div className="space-y-4 text-golddark/50">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-golddark">2. Use of Information</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-golddark">3. Information Sharing</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-golddark">4. Data Security</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-golddark">5. Your Rights</h2>
          <p>
