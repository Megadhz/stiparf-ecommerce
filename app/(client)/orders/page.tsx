    ...
    <Container className="py-10">
      {orders?.length ? (
        ...
        <div className="flex flex-col items-center justify-center py-5 md:py-10 px-4">
          <FileX className="h-24 w-24 text-golddark mb-4" />
          <Title className="text-golddark">No orders found</Title>
          <p className="mt-2 text-sm text-golddark/40 text-center max-w-md">
            It looks like you haven&apos;t placed any orders yet. Start shopping
            to see your orders here!
          </p>
          <Button asChild className="mt-6 bg-golddark text-whitegold hover:bg-golddark/40 hover:text">
            <Link href={"category/new"}>Browse Products</Link>
          </Button>
        </div>
      )}
    </Container>
